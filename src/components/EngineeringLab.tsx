...
export function EngineeringLab() {
  ...
  return (
    <section className="relative mx-auto w-full max-w-7xl px-6 py-28 md:px-10">
      ...
      <p className="mt-4 max-w-xl text-sm text-ink-faint">Hover an instrument to see what it does.</p>
        ...
        {labInstruments.map((inst) => {
          ...
          return (
            ...
            >
              ...
              <div
                className="pointer-events-none absolute -bottom-3 left-1/2 z-10 w-44 border-l border-accent bg-bg-elevated p-3 text-left text-xs leading-snug text-ink-soft shadow-[0_20px_40px_-20px_rgba(0,0,0,0.6)] transition-all duration-200"
                style={{
